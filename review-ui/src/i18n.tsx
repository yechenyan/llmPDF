...
const messages = {
  de: {
    ...
    manualDifferenceTitle: "Vom LLM-Original abweichende manuelle Zellen",
    manualChanges: "{{count}} manuelle Änderungen",
    previousManualChange: "Vorherige Änderung",
    nextManualChange: "Nächste Änderung",
    manualChangePosition: "Manuell {{current}}/{{count}}",
    noManualChanges: "Keine manuellen Änderungen",
    ...
    restoreAi: "LLM-Ergebnis wiederherstellen",
  ...
  en: {
    ...
    manualDifferenceTitle: "Manual cells that differ from the LLM original",
    manualChanges: "{{count}} manual changes",
    previousManualChange: "Previous change",
    nextManualChange: "Next change",
    manualChangePosition: "Manual {{current}}/{{count}}",
    noManualChanges: "No manual changes",
